...
public class SystemInfo {
        ...
        public static boolean isTestingViewChange=false;//String algorithm="Zyzzyyva";
...
//        public static int reply_num=0;
        ...
        //View change test use
        public static int viewChangeTestPeriod=1;//7
        public static int viewChangeTestPrimaryActionFlag=0;
}
